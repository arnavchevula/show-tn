...
<template>
    <div class="border-b-red-200 border-b pb-4 mb-4 flex justify-between">
      <div>
      ...
      <div>
        <UButton variant="ghost" color="neutral" icon="i-lucide-heart" :class="isFavorited(props.show?.id) ? 'text-rose-400' : ''" @click.stop="toggleFavorite(props.show?.id)"/>
      </div>
    </div>
 </template>